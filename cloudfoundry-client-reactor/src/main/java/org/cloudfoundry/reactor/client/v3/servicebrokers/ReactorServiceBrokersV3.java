...
public final class ReactorServiceBrokersV3 extends AbstractClientV3Operations implements ServiceBrokersV3 {
	...
	return post(request, Void.class, builder -> builder.pathSegment("service_brokers"))
		    .checkpoint();
    }
	...
	return patch(request, Void.class, builder -> builder.pathSegment("service_brokers", request.getServiceBrokerId()))
		    .checkpoint();
    }
